"""
    Models for the checkout app which include the order model
"""
...
class OrderLineItem(models.Model):
    ...
    product = models.ForeignKey(Product, null=False, blank=False,
                                on_delete=models.CASCADE)
    product_inventory = models.ForeignKey(ProductInventory, null=True,
    ...
    def save(self, *args, **kwargs):
        ...
        """
        Now check if a Gift Card item purchase
        and create a Giftcard entry
        """
...
class GiftCard(models.Model):
    ...
    giftcard_value = models.DecimalField(max_digits=10, decimal_places=2,
                                         null=False, default=0)
    giftcard_value_remaining = models.DecimalField(max_digits=10,
                                                   decimal_places=2,
                                                   null=False, default=0)
    order_line_item = models.ForeignKey(OrderLineItem, null=False,
